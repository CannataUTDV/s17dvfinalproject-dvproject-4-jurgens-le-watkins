...
+ Finally, in order to get a look at the data from all angles, we created a 3d scatterplot in plotly with population, home internet usage, and work internet usage. Notice there is an extreme outlier (drag and drop the graph to see it better). This chart shows **how District of Colombia is drastically different from the 50 states in terms of young adult percentage.** It also shows that 
