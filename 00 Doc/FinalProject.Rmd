...
This data describes Internet Usage and Connectivity across the United States from July 2015 to October 2016. The columns that we used were a combinations of the census population data,income data, internet usage and connectivity data.
...
We then took the data related to Facebook traffic penetration.
...
And lastly, we brought in data points for internet usage and connectivity.
